...
public class BeMech3_kom extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private ProgressBar progressBar;
    private String WIN15,WIN16,WIN18,WIN17;
    @SuppressLint("SetJavaScriptEnabled")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_mech3_kom);


        WIN15 = "17ZfZqbiEA1jbD01rhjGy_iTnp5CsF3SS";
        WIN16 = "17NWPRQKtFy4doV1NZD_09tgp9PaJ1uKD";
        WIN17 = "17R0v0U_Jtvy0D4eXjlbr4oaKtlUxcKK7";
        WIN18 = "17Y3K55LROtbLlt9ug6relYmwZWHFrXx0";
