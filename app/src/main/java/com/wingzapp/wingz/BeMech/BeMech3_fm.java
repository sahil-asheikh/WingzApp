...
public class BeMech3_fm extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private ProgressBar progressBar;
    private String WIN15,WIN16,WIN18;
    @SuppressLint("SetJavaScriptEnabled")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_mech3_fm);

        WIN15 = "17LT83OuodduI7iaQtvd9q4LWemsIfMCp";
        WIN16 = "17AZxEFrYcM8oQFoCMO2sOT4AqvRCNlfX";
        WIN18 = "17K7wUCUceSLgdaNLgz47DcLq-aSz0S_j";
