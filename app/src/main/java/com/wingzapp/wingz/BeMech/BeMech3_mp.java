...
public class BeMech3_mp extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private ProgressBar progressBar;
    private String WIN16,WIN18,WIN17,WIN15;
    @SuppressLint("SetJavaScriptEnabled")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_mech3_mp);

        WIN16 = "17m-8Hkh1xSQEoBBm2toHiH2YYH00V69C";
        WIN17 = "17h9MDKLpp6EUm8zYUfHHq7G0WajlBmsa";
        WIN15 = "17jEsZUGxCUmOMJBjk-5MxjWRrCcFJJ2Q";
        WIN18 = "17p2y0znWbjQhH6b4vWKdrgDivzKPCksV";
