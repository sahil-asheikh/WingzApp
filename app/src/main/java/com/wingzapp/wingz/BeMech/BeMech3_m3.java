...
public class BeMech3_m3 extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private ProgressBar progressBar;
    private String WIN16,WIN18,WIN17;
    @SuppressLint("SetJavaScriptEnabled")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_mech3_m3);

        WIN16 ="17eN_W5e3EwCf7nKztDQ8zA0bSoE-yqsa";
        WIN17 ="17aSuo_8Di6SoK8K1J_Du6zlZTTcgY4pG";
        WIN18 ="17gkx83uYpWU7pjxefi9-hF9HwpKSGeKQ";
