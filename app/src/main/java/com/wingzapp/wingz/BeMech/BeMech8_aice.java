...
public class BeMech8_aice extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private ProgressBar progressBar;
    private String WIN16,WIN18,WIN17,SUM17,SUM18,SUM19;
    @SuppressLint("SetJavaScriptEnabled")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_mech8_aice);

        WIN16 =  "1C93vOLMoNFdxudNTwEZEO-LxHGK3RqWA";
        SUM17 =  "1Bc09wSZfOo3Eft4nLkfdXaPVgPcs47J7";
        WIN17 =  "1B-NZzqnvb7AvYhHOk-A4yYIVSeBjLyDn";
        SUM18 =  "1A6UO98n5qIAFRSzSRB2QV7rbseVfJA97";
        WIN18 =  "19K2nq1DSlS4DuIRgMgY9VshotK8dvw3z";
        SUM19 =  "18FS2vMp7kNO-JTIm_j2ozp8NGUFISY2t";
