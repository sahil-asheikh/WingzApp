...
public class BeMech4_hm extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private ProgressBar progressBar;
    private String WIN16,WIN18,WIN17,SUM17,SUM16;
    @SuppressLint("SetJavaScriptEnabled")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_mech4_hm);

        SUM17 = "18Pkuif3bDBRlimWNviKbCPOHSAz94kT6";
        WIN16 = "18JLd-NtwmDNquD7QvzERzOmP2QnLuIqk";
        WIN17 = "18O8832CEbQ2ucwDJChir2TMpUt8KaFbx";
        SUM16 = "18Gl8tylPiuybX9GuIzovCtqopfZzLSJ8";
        WIN18 = "18USRq87GozMkZZnSFyGNEopr0Zp2Xebx";
