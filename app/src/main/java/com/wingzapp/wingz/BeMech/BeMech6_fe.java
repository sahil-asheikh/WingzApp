...
public class BeMech6_fe extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private ProgressBar progressBar;
    private String WIN16,WIN18,WIN17,SUM17,SUM18;
    @SuppressLint("SetJavaScriptEnabled")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_mech6_fe);

        WIN16 =  "1mg2mkaPaUc95VrK2pVb3rxlm6mcN7v2X";
        SUM17 =  "1TLgl5JdPioKgWOdyjj5K1y4e2QL-PtBQ";
        WIN17 =  "1GyB48okwLlyMAGa1Al7VuxOm7rrlCw44";
        SUM18 =  "16XA-zDRqiLLxlSGUWTth9HxKhRBpqYG0";
        WIN18 =  "1j3jKK-yO4ejT44ybkR2-frOqFZ-PVqCu";
