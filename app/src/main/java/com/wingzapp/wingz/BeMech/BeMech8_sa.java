...
public class BeMech8_sa extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private ProgressBar progressBar;
    private String WIN18,WIN17,SUM17,SUM18,SUM19;
    @SuppressLint("SetJavaScriptEnabled")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_mech8_sa);

        SUM17 =  "1BbY0-yj1-xMx2D_tV7u8DlsQM20tkVjw";
        WIN17 =  "1AqmU-jePIeaZYsWkbxQfWA3H07T_kUh3";
        SUM18 =  "1A3GAbATONODA22CpHAB159IPHkyGPVTA";
        WIN18 =  "19j5WjWk4ybfBD_RM6tr4CcEfe9M0m1bR";
        SUM19 =  "18xRJk6HeXfYANK35mpSNJIi5dtfSEjP8";
