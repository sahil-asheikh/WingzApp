...
public class BeMech4_mom extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private ProgressBar progressBar;
    private String WIN16,WIN17,SUM15,SUM17,SUM16;
    @SuppressLint("SetJavaScriptEnabled")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_mech4_mom);

        SUM15 ="18j1lgjDkz7kmXI8yKCe4eHweySYWPOM-";
        SUM17 ="18xP_HDpUK-18ArgGE5iMiWFUJT9ZZdhV";
        WIN16 ="18oKm7Ni_mvqMbTd_a71AnKdsnM1HFr_C";
        WIN17 ="18tHMJafZJCXIwCPc30XtngmCd0RSs6QZ";
        SUM16 ="18pNji_pMzjv8koiKwse5ZY27FE3ISgeR";
