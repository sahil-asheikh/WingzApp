...
public class BeMech8_cim extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private ProgressBar progressBar;
    private String WIN16,WIN17,SUM17,SUM18,SUM19;
    @SuppressLint("SetJavaScriptEnabled")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_mech8_cim);

        WIN16 =  "1CGNMZI17Sn02Cxgo9-AlIb8vgh3stJv1";
        SUM17 =  "1BRD5BeFJE_MhOVb9mC4fvua242N-2Yiv";
        WIN17 =  "1A_6NwCS0lRGdxmkK9sJt8halgfTRwIiw";
        SUM18 =  "19pF_UAxbRryp1dAK4k2zR1_-bgwt-eJ7";
        SUM19 =  "18IihOHuuAC5PdcRplpb87NU3ptpIN2iw";
