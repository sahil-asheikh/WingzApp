...
public class BeMech4_mp extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private ProgressBar progressBar;
    private String WIN16,WIN18,WIN17,SUM16;
    @SuppressLint("SetJavaScriptEnabled")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_mech4_mp);

        WIN16 ="19B3Nl5gm9Ky4704UVHP5SkDnRhchUZr5";
        WIN17 ="19J16r_PN_gD3x7t60SkQwAwFPSt5-YTU";
        SUM16 ="19LhbxrTnRTVpG0F2cbTwbXdugShaRYOs";
        WIN18 ="19R3hmrljy3gz20P54tgGVf-rl0VOc0zc";
