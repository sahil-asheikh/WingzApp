    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s15.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                webView.loadUrl("https://drive.google.com/viewerng/viewer?embedded=true&url=https://drive.google.com/u/1/uc?id=1PnlsbNg4XpNkOYoY-6XEvO8tP_xF8w87&export=download");
        ...
        w15.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                webView.setVisibility(View.VISIBLE);
                cardView.setVisibility(GONE);
                webView.loadUrl("https://drive.google.com/viewerng/viewer?embedded=true&url=https://drive.google.com/u/1/uc?id=1Pp500A-_xjVKI02_GBKryup309kVk6lM&export=download");
        ...
        w17.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                webView.setVisibility(View.VISIBLE);
                cardView.setVisibility(GONE);
                webView.loadUrl("https://drive.google.com/viewerng/viewer?embedded=true&url=https://drive.google.com/u/1/uc?id=1QErPSEtL-OkKE4EZlVxlBVBPi_tsxY8Q&export=download");
        ...
        w18.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                webView.setVisibility(View.VISIBLE);
                cardView.setVisibility(GONE);
                webView.loadUrl("https://drive.google.com/viewerng/viewer?embedded=true&url=https://drive.google.com/u/1/uc?id=1PrlAqGjXWVqN717oHdKB_-qr7g29Sgnb&export=download");
