...
public class BeExpo6_fe extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private ProgressBar progressBar;
    private String WIN16,WIN17,SUM18,SUM17;
    @SuppressLint("SetJavaScriptEnabled")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_expo6_fe);


        SUM18 = "1BD8ZJTRn9Hon90eJsL8oVMXz2VXPbfyS";
        WIN17 = "1BGYlzMG5JT-Ka9WJ6a_ypl5tHNiErQIZ";
        SUM17 = "1B73iDV0ppIJXpseZXic5yG2dg9PAOSzG";
        WIN16 = "1BErxfkgKNAcFN7CuyIdEv8SZ-ANvte8X";
