...
public class BeExpo6_edtc extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private ProgressBar progressBar;
    private String WIN16,WIN17,SUM19,SUM18,SUM17,SUM16;
    @SuppressLint("SetJavaScriptEnabled")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_expo6_edtc);

        SUM19 = "1ApPaXzrr61ioxxpAQXhPu7OChV24xdBB";
        SUM18 = "1B6uyiRDxv2nqeL-GdeA0ICkcK3SQLcSI";
        WIN17 = "1B-6vncFv9vKGQKvCgtVpt4FH2FdI-Ist";
        SUM17 = "1AuIbH8MBluGFxRQW5oTjww14q_RH77pV";
        WIN16 = "1AvPFbjB-Vb78gks4EmnwiqyTm3C_KQ_b";
        SUM16 = "1AqZQAxxsGIzofxlgyhKXn1sykShvz_xS";
