...
public class BeExpo8_sp extends AppCompatActivity {
    Button s19, s18, s17, s16, s15, w19, w18, w17, w16, w15;
    WebView webView;
    CardView cardView;
    private ProgressBar progressBar;
    private String WIN16, WIN17, SUM19, SUM18;

    @SuppressLint("SetJavaScriptEnabled")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_expo8_sp);

        SUM19 = "1Eo7GFJfsLWpH4IAPs3DXk3q0llmiq-AF";
        SUM18 = "1Eva0z9EP8lmPXZtLtqfYuqts5xUVpeNo";
        WIN17 = "1EvV9bW6FMma9tO8csw9Tk52Kf9R9D4FL";
        WIN16 = "1EqwcjcqIJGA68XeTfjYOs41SThothYht";
