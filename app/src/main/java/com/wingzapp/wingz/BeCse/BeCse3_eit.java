...
public class BeCse3_eit extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private ProgressBar progressBar;
    private String sum17,sum18,win15,win16,win17;
    @SuppressLint("SetJavaScriptEnabled")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_cse3_eit);

        sum18="11jmehuQH0uTQ3BuFr3AxFgHrm1HydpLM";
        win17="128gB8jySFfiN7u2j1onluYwpejTjekbG";
        sum17="11zFW-BM3d0D1YoH9xjvWJVJnZXBlCTsw";
        win16="120JKWodZx-syM2itV0Ctz5q2RqTc0AAY";
        win15="11iSN0FByRkLsI9kaAjjKZgdGH8XIAOG1";
