...
public class BeCse7_mc extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private String sum19,sum16,sum17,win15,win16,win17,win18,sum18;
    private ProgressBar progressBar;
    @SuppressLint("SetJavaScriptEnabled")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_cse7_mc);

        sum19 = "1feoeOk7MTxaO8AD0GlkdsL3Nx8C8Ib9Q";
        win18 = "1pz0CjrVbZMVz10cQHaqSWDFrkG1GQjdK";
        sum18 = "1xB7ws2euyUGNJ7gy4jlaclpXOaIk9LSn";
        win17 = "1HqiGyPdz1cd8r9pXrgSHbgv6y42XO5r1";
        sum17 = "1GsBE0bqDaTjyG1k7JlhGT7ARJAjGo2zi";
        win16 = "157FdRsLOHrXAKzDpSlo5jZ2eQy4J2GTc";
        sum16 = "10yo5yIGAWsjl35CKHIdszQPQSlPcVLhW";
        win15 = "15RYa6cl4kXw-ILM1YKx_h4n3xdL3o49f";
