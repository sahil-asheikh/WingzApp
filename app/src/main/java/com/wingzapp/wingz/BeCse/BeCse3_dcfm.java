...
public class BeCse3_dcfm extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private ProgressBar progressBar;
    private String sum16,sum18,win15,win16,win17,win18;
    @SuppressLint("SetJavaScriptEnabled")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_cse3_dcfm);

        win18="11NTJHtlpe2u0gwL77kqTdL3WyHMKKMDz";
        sum18="11LlGFDVzVwuUbo2gj8OAycajPkI-mmEq";
        win17="11YtGKHw5hqTgsd62DUR--VZL6pd9o9nu";
        win16="11YfM64VSS0B0MjI18poeuVvHSE4OeiyD";
        sum16="11XGacOLh0BOk_HG70jFZHQcMJA40Nqyz";
        win15="11AOXJTDyLWCMGds1lugfghxezG2ZHI57";
