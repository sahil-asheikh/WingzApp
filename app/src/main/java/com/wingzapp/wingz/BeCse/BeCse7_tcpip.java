...
public class BeCse7_tcpip extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private String sum19,sum16,sum17,win16,win17,win18,sum18;
    private ProgressBar progressBar;
    @SuppressLint("SetJavaScriptEnabled")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_cse7_tcpip);

        sum19 = "1TBTKsRFedEFHWP-I6PRs6x9pm_yCfvjc";
        win18 = "17bKWSl8qKfJoMKkQQxr76kvm-P2dTmLE";
        sum18 = "1Cgam_QcjQRIyEI7rNd0rGaM5qEWyV2C_";
        win17 = "1aDiftNIv8iZVi0Hs6sZSDlmPxJD4VEAO";
        sum17 = "1aQ5m1Ei4DDs_OyWONyGj0H7fnxrSu2fW";
        win16 = "1JGA0IGRDNyz5K08S7qSoCqt3TeZsWO34";
        sum16 = "1AzH5cfWVifTseb1l43XJAwWyb8Ic9eTJ";
