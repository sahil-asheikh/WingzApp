...
public class BeCse7_dwm extends AppCompatActivity {
    Button s19,s18,s17,s16,s15,w19,w18,w17,w16,w15;
    WebView webView;
    CardView cardView;
    private String sum19,sum16,sum17,win15,win16,win17,sum18;
    private ProgressBar progressBar;
    @SuppressLint("SetJavaScriptEnabled")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_be_cse7_dwm);

        sum19 = "19APs16rz4bHcrdAIL3XVLiKOe9KQEZko";
        sum18 = "1H5CATeD0aIUwQpavhSAqBR-KjSIGLPbo";
        win17 = "1gzZeoFu_WCkta0T7IwWDUxZJ9cpWkvu1";
        sum17 = "1KckHTSUbx6roGq9Mxbxs8FejGY4-htKs";
        win16 = "1eQjDDBeLre9aiMLaxBY51mZqM-wWxasT";
        sum16 = "1KLqvx5IZ8yvbqApZnfanUUqfzTGUnInW";
        win15 = "1cfCeK6jNrCC2VUk733Hei0vRAR3ww_KH";
