    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s15.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                webView.loadUrl("https://drive.google.com/viewerng/viewer?embedded=true&url=https://drive.google.com/u/1/uc?id=14scg2kqtJg2ZcOEmyi2XhT1QsxeV9slD&export=download");
        ...
        s16.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                webView.setVisibility(View.VISIBLE);
                cardView.setVisibility(GONE);
                webView.loadUrl("https://drive.google.com/viewerng/viewer?embedded=true&url=https://drive.google.com/u/1/uc?id=14lUkhdmxjk0cDC93dRIw16zEZ5t9MyzN&export=download");
            }
        });
        s17.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                webView.setVisibility(View.VISIBLE);
                cardView.setVisibility(GONE);
                webView.loadUrl("https://drive.google.com/viewerng/viewer?embedded=true&url=https://drive.google.com/u/1/uc?id=14qrefug3vTcDuHcWSuZlx1yarOmDlKli&export=download");
        ...
        w16.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                webView.setVisibility(View.VISIBLE);
                cardView.setVisibility(GONE);
                webView.loadUrl("https://drive.google.com/viewerng/viewer?embedded=true&url=https://drive.google.com/u/1/uc?id=14tNCqBefhtK0cg9cIm3buZGn-DWMzuK7&export=download");
        ...
        w17.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                webView.setVisibility(View.VISIBLE);
                cardView.setVisibility(GONE);
                webView.loadUrl("https://drive.google.com/viewerng/viewer?embedded=true&url=https://drive.google.com/u/1/uc?id=14wt7o7Tzf92oNR4NPC6zc-239ztknuOi&export=download");
        ...
        w18.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                webView.setVisibility(View.VISIBLE);
                cardView.setVisibility(GONE);
                webView.loadUrl("https://drive.google.com/viewerng/viewer?embedded=true&url=https://drive.google.com/u/1/uc?id=14vwklHC1VG8BAPGKMwG_9HTiL8qzKXhZ&export=download");
