    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s17.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                webView.loadUrl("https://drive.google.com/viewerng/viewer?embedded=true&url=https://drive.google.com/u/1/uc?id=1Bvuo1y8YYYL0ZBLw3Dmsa-lYUq8vfozN&export=download");
        ...
        s18.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                webView.setVisibility(View.VISIBLE);
                cardView.setVisibility(GONE);
                webView.loadUrl("https://drive.google.com/viewerng/viewer?embedded=true&url=https://drive.google.com/u/1/uc?id=1C28xVhz8EKJcHNgJbjUANn8XJW-TsA-i&export=download");
        ...
        w15.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                webView.setVisibility(View.VISIBLE);
                cardView.setVisibility(GONE);
                webView.loadUrl("https://drive.google.com/viewerng/viewer?embedded=true&url=https://drive.google.com/u/1/uc?id=1Bv22mHGmveYgCD3DZJox0afCoKpJSxQo&export=download");
        ...
        w17.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                webView.setVisibility(View.VISIBLE);
                cardView.setVisibility(GONE);
                webView.loadUrl("https://drive.google.com/viewerng/viewer?embedded=true&url=https://drive.google.com/u/1/uc?id=1C9OuvpxvnxpsEs9SgNQ4UdSAX1pAekzK&export=download");
        ...
        w18.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                webView.setVisibility(View.VISIBLE);
                cardView.setVisibility(GONE);
                webView.loadUrl("https://drive.google.com/viewerng/viewer?embedded=true&url=https://drive.google.com/u/1/uc?id=1BvvD7FnfEoyuhYVeWZaq8DOKNAhUtJLg&export=download");
